namespace AsyncProgrammingDemo1
{
	partial class Form1
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			btnProcess1.Location = new Point(120, 97);
			btnProcess1.Name = "btnProcess1";
			btnProcess1.Size = new Size(105, 52);
			...
			btnProcess2.Location = new Point(440, 97);
			btnProcess2.Name = "btnProcess2";
			btnProcess2.Size = new Size(105, 52);
